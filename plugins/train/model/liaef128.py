...
class Model(ModelBase):
    ...
    def intermediate(self):
        ...
        input_ = Input(shape=(None, 8 * 8 * 1024))
        var_x = input_
        var_x = Dense(self.encoder_dim//4)(var_x)
        var_x = Dense(8 * 8 * int(self.encoder_dim//2))(var_x)
        var_x = Reshape((8, 8, int(self.encoder_dim//2)))(var_x)
